-- Create RPC function to clear data for import
-- PRESERVES: insurance_companies, pricing_rules, branches, profiles, user_roles, 
--            notifications, announcement_dismissals, announcements, auth_settings, 
--            payment_settings, invoice_templates, sms_settings, insurance_categories,
--            road_services, accident_fee_services, company_road_service_prices,
--            company_accident_fee_prices, company_accident_templates, insurance_company_groups
