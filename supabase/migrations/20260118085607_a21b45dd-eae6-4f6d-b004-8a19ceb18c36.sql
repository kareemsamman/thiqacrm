...
BEGIN
  -- First, detach preserved configuration records from transactional entities (FK-safe)
  ...
  -- Using TRUNCATE with RESTART IDENTITY CASCADE to handle all FK dependencies automatically
  TRUNCATE TABLE
    ab_ledger,
