-- Fix the profit calculation function
-- DISCOUNT is a fixed ₪ amount that REPLACES the third component, not a percentage
...
BEGIN
  ...
  -- Default fallback: no profit calculation possible
