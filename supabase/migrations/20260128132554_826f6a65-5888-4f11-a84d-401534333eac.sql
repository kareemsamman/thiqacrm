-- Drop and recreate with correct column name (transferred not transfered)
DROP FUNCTION IF EXISTS public.report_created_policies;
DROP FUNCTION IF EXISTS public.report_renewals;

-- Recreate report_created_policies with correct column name
...
-- Recreate report_renewals with correct column name
