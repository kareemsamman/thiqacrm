-- Fix get_client_balance to use policy_payments instead of client_payments
-- This ensures accurate debt tracking by reading from the correct source of truth
